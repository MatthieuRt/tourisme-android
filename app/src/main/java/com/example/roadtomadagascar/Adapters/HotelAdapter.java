...
public class HotelAdapter extends RecyclerView.Adapter<HotelAdapter.ViewHolder>{
    ...
    public HotelAdapter(ArrayList<HotelDomain> items) {
        this.items = items;
    }
    ...
    public HotelAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View inflate = LayoutInflater.from(parent.getContext()).inflate(R.layout.viewholder_hotel,parent,false);
